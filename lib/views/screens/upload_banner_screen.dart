...
class UploadBanners extends StatefulWidget {
  static const String id = '\UploadBanners'; //! this is routing
...
class _UploadBannersState extends State<UploadBanners> {
  ...
  final FirebaseStorage _firebaseStorage = FirebaseStorage.instance;   //! STORAGE INSTANCE TO STORE AND GENERATE URL FOR THE ITEM.
  ...
  _uploadImageToStorage(dynamic image) async {
    //! THIS IS USED TO UPLOAD IMAGE TO FIREBASE STORAGE
    Reference ref =
                          ...
                          Container(
                            ...
                            child: Center(
                              child: _image != null
                                  ? Image.memory(_image)
                                  : Text(
                                      //! HERE WE USED THE CODE TO SHOW THE IMAGE
                                      'Banner Image',
                                    ),
                            ),
                          ),
